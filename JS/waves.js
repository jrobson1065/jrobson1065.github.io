window.requestAnimFrame = (function () {
  ...
  Water.prototype.update = function (index) {
  ...
  function loop() {
    ...
    if (limiterTick >= limiterTotal) {
      if (mousedown) {
        waters.push(new Water(-100, my, -100, my));
        limiterTick = 0;
      }
    } else {
      limiterTick++;
